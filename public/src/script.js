(function(){
  ...
  var Quiz = React.createClass({
    ...
    render: function(){
      ...
      <div>
        <div className="row">
          ...
          <div className="col-md-7">
            {this.state.books.map(function(b, id){
              return <Book onBookSelected={this.handleBookSelected} key={id} title={b} />
            }, this)}
          </div>
        ...
        <div className="row">
            <div className="col-md-12">
                <input onClick={this.handleAddGame} type="button" className="btn btn-primary" value="Add Game"/>
            </div>
        </div>
      </div>
      )
  ...
  routie({
    ...
    'add': function(){
      React.render(<AddGameForm onGameFormSubmited={handleAddFormSubmitted} />, document.getElementById("app"))
    }
  })
